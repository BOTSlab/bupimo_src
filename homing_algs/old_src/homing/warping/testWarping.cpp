/**
 * Test of Ralf Moeller's warping code, which implements the warping method for
 * visual homing described in the following paper:
 *
 ...
 *
 * Currently relies on the Img library which should be present in "../../img",
 * although any other image representation method can easily be swapped in.
 *
 * @author Andrew Vardy
 */
